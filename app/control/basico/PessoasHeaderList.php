...
class PessoasHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $uf->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1']));
        ...
        $action_onEdit = new TDataGridAction(array('PessoasForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('PessoasHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de pessoass");
        ...
        $button_cadastrar->setAction(new TAction(['PessoasForm', 'onShow']), "Cadastrar");
        ...
        // $dropdown_button_exportar->addAction( "CSV", new TAction(['PessoasHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        // $dropdown_button_exportar->addAction( "XLS", new TAction(['PessoasHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        // $dropdown_button_exportar->addAction( "PDF", new TAction(['PessoasHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        // $dropdown_button_exportar->addAction( "XML", new TAction(['PessoasHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Básico","Pessoass"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new Pessoas($key, FALSE); //</blockLine>
...
//<generated-DatagridHeaderAction-onExportCsv>
    public static function onExportCsv($param = null) 
    {
        try
        {
...
//<generated-DatagridHeaderAction-onExportXls>
    public static function onExportXls($param = null) 
    {
        try
        {
...
//<generated-DatagridHeaderAction-onExportPdf>
    public static function onExportPdf($param = null) 
    {
        try
        {
...
//<generated-DatagridHeaderAction-onExportXml>
    public static function onExportXml($param = null) 
    {
        try
        {
...
//</generated-DatagridHeaderAction-onExportXml>
    ...
    public function onReload($param = NULL)
    {
        try
        {
            // open a transaction with database 'pessoas_fisicas'
            TTransaction::open(self::$database);
